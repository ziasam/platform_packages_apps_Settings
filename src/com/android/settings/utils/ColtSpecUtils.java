...
public class ColtSpecUtils {
    ...
    private static final String MAINTAINER_NAME_MODEL_PROPERTY = "ro.colt.maintainer";
    ...
    private static final String COLT_MAINTAINER_PROPERTY = "ro.colt.maintainer";
